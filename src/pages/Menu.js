      ...
      <KeyboardAvoidingView style={styles.background} >
        ...
        <View style={styles.container}>
          ...
          <View style={{
            ...
            <TouchableOpacity accessibilityLabel='Ver projetos' onPress={() => ver()} style={styles.ver}>
              <Text style={{ color: '#9E9E9E', fontSize: 20, textAlign: 'center' }}>Ver projetos</Text>
            </TouchableOpacity>

            <TouchableOpacity accessibilityLabel='Sair da conta' style={styles.sair} onPress={() => sair()}>
              <Text style={{ color: '#9E9E9E', fontSize: 20, textAlign: 'center' }}>Sair da conta</Text>
            </TouchableOpacity>

            <TouchableOpacity accessibilityLabel='Excluir conta' style={styles.excluir} onPress={() => excluir()}>
